...
const metodologia = [
  {
    step: "01",
    title: "Diagnóstico",
    desc: "No recetamos sin examinar. Analizamos tus datos y procesos actuales para encontrar fugas y oportunidades claras."
  },
  {
    step: "02",
    title: "Orden",
    desc: "Priorizamos lo que tiene más impacto con el menor esfuerzo. Creamos tu hoja de ruta clara y accionable."
  },
  {
    step: "03",
    title: "Ejecución",
    desc: "Hacemos que las cosas pasen. Implementamos los cambios sin excusas ni retrasos, con tu equipo o el nuestro."
  },
  {
    step: "04",
    title: "Medición",
    desc: "Lo que no se mide no existe. Informes semanales sobre lo que importa: conversiones, ventas y ROI real."
  }
];
